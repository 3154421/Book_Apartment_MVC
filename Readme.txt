...
Update-Database -Context Book_Apartment_IDContext



5. On the console execute the following command

Update-Database -Context Book_Apartment_DataContext 



6. After migration is successful Run the project 

7 if you click on Apartments/Renters etc (Except Home) will redirect you to ASP .net identity login page login from the following credentials

User : admin@apartments.com
Password: 1qaz2wsX@
